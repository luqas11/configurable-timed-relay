...
// Attempts to connect to a WiFI network using the stored credentials, blinking the given LED while trying. If, after 10 seconds the connection is not established, it stops trying.
